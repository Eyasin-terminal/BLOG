...
<head>
  ...
  <meta name="description" content="{{ page.excerpt | default: site.description | strip_newlines | strip_html | truncate: 160 }}">
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <nav class="site-nav">
        ...
        <a class="nav-link" href="{{ "/feed.xml" | relative_url }}">RSS</a>
      </nav>
    </div>
  </header>
  ...
  <footer class="site-footer">
    <div class="container footer-inner">
      ...
      <div class="footer-links">
        ...
        <span class="meta-divider">•</span>
        <a class="footer-link" href="{{ "/feed.xml" | relative_url }}">RSS Feed</a>
      </div>
    </div>
  </footer>
